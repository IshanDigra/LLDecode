...
import Problems.MEDIUM.TicketBookingSystem.Model.Seat;
import Problems.MEDIUM.TicketBookingSystem.Model.User;
import Problems.MEDIUM.TicketBookingSystem.Service.ConcertBookingSystem;
...
public class TicketBookingDemo {
    public static void main(String[] args) {
        ...
        for (Concert concert : searchResults) {
            System.out.println("Concert: " + concert.getArtist() + " at " + concert.getVenue() + " On "+concert.getDateTime().toLocalDate());
