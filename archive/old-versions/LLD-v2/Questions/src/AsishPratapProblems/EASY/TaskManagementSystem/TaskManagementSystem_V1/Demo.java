package AsishPratapProblems.EASY.TaskManagementSystem.TaskManagementSystem_V1;

import AsishPratapProblems.EASY.TaskManagementSystem.TaskManagementSystem_V1.Enum.TaskPriority;
import AsishPratapProblems.EASY.TaskManagementSystem.TaskManagementSystem_V1.Model.Task;
import AsishPratapProblems.EASY.TaskManagementSystem.TaskManagementSystem_V1.Model.TaskManager;
import AsishPratapProblems.EASY.TaskManagementSystem.TaskManagementSystem_V1.Model.User;
...
public class Demo {
    public static void main(String[] args) {
        ...
        Task t1 = tm.createTask(user1, "Movie Plan", "Planning about a movie", LocalDateTime.now(), TaskPriority.LOW) ;
        Task t2 = tm.createTask(user1, "Coding", "coding schedule", LocalDateTime.now().plusSeconds(50), TaskPriority.HIGH) ;
        Task t3 = tm.createTask(user2, "Chill", "Planning about mandir visit", LocalDateTime.now(), TaskPriority.MEDIUM) ;
        // assign task
