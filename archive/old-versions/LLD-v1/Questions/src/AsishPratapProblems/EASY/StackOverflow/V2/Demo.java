package AsishPratapProblems.EASY.StackOverflow.V2;

import AsishPratapProblems.EASY.StackOverflow.V2.Entities.*;
...
public class Demo {
    public static void main(String[] args) {
        ...
        User pallav = new User(2, "Pallav");
        User Mehak = new User(3, "Mehak");
