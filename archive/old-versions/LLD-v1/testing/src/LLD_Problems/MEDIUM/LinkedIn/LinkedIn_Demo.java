package LLD_Problems.MEDIUM.LinkedIn;

import LLD_Problems.MEDIUM.LinkedIn.BusinessLogic.LinkedIn;
import LLD_Problems.MEDIUM.LinkedIn.Model.JobPosting;
import LLD_Problems.MEDIUM.LinkedIn.Model.Notification;
import LLD_Problems.MEDIUM.LinkedIn.Model.Profile;
import LLD_Problems.MEDIUM.LinkedIn.Model.User;
...
public class LinkedIn_Demo {
    public static void main(String[] args) {
        LinkedIn linkedInService = LinkedIn.getInstance();
